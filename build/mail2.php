...
$message = iconv('UTF-8', 'cp1251', "<b>Заказ на деталь</b><br><b>Имя: </b> ").iconv('UTF-8', 'cp1251', $_REQUEST['name']).iconv('UTF-8', 'cp1251', "<br> <b>Телефон: </b>").iconv('UTF-8', 'cp1251', $_REQUEST['phone']).'';
